create database AssignmentOnSql2
...
create table Worker_on(emp_no integer not null,
...
select emp_no from Work_on where Job='Clerk'

--Question 3

select emp_no as 'Employee Number' from Work_on where project_no='p2' and emp_no<10000

--Question 4
select emp_no as 'Employee Number' from Work_on where enter_date not like '1998'

--Question 5

select*from Work_on where project_no='p1'